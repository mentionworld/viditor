...
const Hero = () => {
  return (
    <div className='flex w-full flex-col md:flex-row items-center justify-between p-16 pt-20 md:pt-40 gap-20 relative'>
      <div className='gradient-02 absolute left-1/2 w-1/2 inset-0'></div>
