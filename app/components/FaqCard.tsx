    ...
    <div className={`p-4 md:p-6 ${isOpen ? 'bg-blue-950 rounded-xl' : ''}`}>
        <div className='flex flex-row justify-between items-center mb-2'>
            ...
            <div onClick={() => setIsOpen(!isOpen)} 
                className='w-8 h-8 flex-center ml-4 md:ml-8 rounded-full bg-radial-blue-gradient ring-1 ring-blue-950 ring-offset-1 ring-offset-slate-950 cursor-pointer'>
