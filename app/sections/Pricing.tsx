...
import PricingSvg from '../components/PricingSvg'
...
const Pricing = () => {
  ...
  return (
    <div className='px-4 lg:px-16 pt-28 mt-8 relative' id='pricing'>
      ...
      <h2 className='h2 text-center w-80 md:w-96 mx-auto relative z-10'>Flexible PRice <br /> for teams of all sizes</h2>
      ...
      <div className='w-fit flex flex-col md:flex-row items-center gap-y-28 mx-auto'>
        ...
        <div className='px-12 lg:px-14 py-6 border-2 border-blue-800 bg-blue-950 rounded-3xl z-10'>
          <Plan 
          icon={FaPeopleGroup}
